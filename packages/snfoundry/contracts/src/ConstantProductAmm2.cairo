use starknet::ContractAddress;
 ...
 pub trait IConstantProductAmm<TContractState> {
     ...
     fn get_amount1_out(self: @TContractState, amount0: u256) -> u256;
 }
     ...
     impl ConstantProductAmm of super::IConstantProductAmm<ContractState> {
         ...
         fn add_liquidity(ref self: ContractState, amount0: u256, amount1: u256) -> u256 {
             ...
             if (reserve0 > 0 || reserve1 > 0) {
                 let product_now = reserve0 * reserve1;
                 let product_after = (reserve0 + amount0) * (reserve1 + amount1);
                 assert(product_after >= product_now, 'x / y != dx / dy');
             }
         ...
         fn get_amount1_out(self: @ContractState, amount0: u256) -> u256 {
             ...
             let mut amount1_out = amount0;
 
             if (reserve0 > 0 || reserve1 > 0) {
                 amount1_out = (reserve1 * amount0) / reserve0 + 1;
             }
             amount1_out
